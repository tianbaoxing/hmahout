...
public class ItemBasedRecommender {
	...
	public static void main(String[] args) {
		ItemBasedRecommender basedRecommender = new ItemBasedRecommender();
		long startime = System.currentTimeMillis();
		System.err.println("--------------------------------------------------------------");
		List<RecommendedItem> recommendations = basedRecommender.itemBasedRecommender(1, 3);
		...
		System.err.println("耗时:"+(endTime-startime));
		System.out.println("===============================================================");
	}
}
